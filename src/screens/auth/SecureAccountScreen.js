...
// Lets a user prove who they are so they can undo an unauthorized password change.
// Native Google Sign-In is not available in Expo Go; recovery is currently
// pointed at the web app until a development build is set up.
...
const SecureAccountScreen = ({ navigation, route }) => {
  ...
  // Native Google Sign-In needs a custom dev build and is not available in Expo Go.
  const handleGooglePress = () => {
    Alert.alert(
      'Google Sign-In unavailable',
      'This recovery flow needs a development build. Use the web app to verify with Google, or sign in with your original password.',
